...
# Pick a GPIO pin to connect to abort relay
abort_pin = 23
...
abort_confirm = input('If you continue, the balloon will fall from the sky! Are you REALLY sure you want to abort? [y/n]')
...
print('The HAB3 is falling now...goodbye.')
sys.exit()